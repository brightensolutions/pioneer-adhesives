      ...
      <div className="absolute inset-0 flex flex-col justify-center text-white bg-[#000e2ac9] bg-opacity-80 px-[20px]">
        <div className="lg:max-w-[1440px] m-auto ">
          <div className="flex lg:flex-row md:flex-row items-center">
            <motion.div
              className="lg:w-[50%] bg-[#0000004a] lg:p-[44px] rounded-[10px] box"
              initial={{ opacity: 0, x: -50 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 1, ease: "easeOut" }}
            >
              <p className="lg:text-[29px] xl:text-[35px] text-center font-oxanium text-customRed font-bold bg-[#3d3d3e5e] pt-[5px] welcome_border border-[1px] border-[#ffffff12] ">
                Welcome To Our Website
              </p>
              <div className="flex flex-col items-center">
                <h1 className="threed_text lg:text-[104px] xl:text-[128px] font-oxanium text-customBlue">
                  PIONEER
                </h1>
